(function(forecast,$,undefined){
	...
	forecast.getZipCode=function(){
		...
		button.onclick=function(){
			...
			if(zip.length!=5){
				...
				$("#noMatch").append("Enter a valid zip code");
			}else{
				$("#noMatch").empty();
	...
	forecast.getForecast=function(value){
		...
		var key="0fa34007aa028bb5";
		var urlAPI="http://api.wunderground.com/api/"+key+"/features/forecast/q/"+value+"/format.json";
